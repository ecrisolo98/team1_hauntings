...
var color=["#D0CFCF","#e8c9c9","#efa7a7","#f58484","#d882a0","#eaae6b","#efa350","#f3850c","#c74573","#ef6464","#9c4108","#9c4108","#f74646","#f11616","#9e1717","#eaae6b"]
...
var data = d3.json("../data/team11heatmapdata.json", function(error, root){
 ...
 console.log()
  var jsonList = root["response"]["docs"]
jsonList = shuffle(jsonList)
...
for (var i = 0; i < MapRows; i++) {
    for (var j = 0; j < MapColumns; j++) {
        var sMovies = jsonList[count]["sighted_at_movie_list"][0].split(",");
        var rMovies = jsonList[count]["reported_at_movie_list"][0].split(",");
        points.push([hexRadius * j * 1.75, hexRadius * i * 1.5,jsonList[count]["sighted_at_movie_count"],sMovies]);
        points2.push([hexRadius * j * 1.75, hexRadius * i * 1.5,jsonList[count]["reported_at_movie_count"],rMovies]);
        count++;
    }//for j
}//for i
